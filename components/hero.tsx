      ...
      <div className="relative z-10 my-20 flex justify-center">
        <div className="flex max-w-[89vw] flex-col items-center justify-center md:max-w-2xl lg:max-w-[60vw]">
          ...
          <TextGenerateEffect
            ...
            words="Transforming Data into Intelligent, Seamless User Experiences with AI/ML."
          />
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:mt-10">
            ...
            <a href="/Resume.pdf" download={`${links.ownerName}_Resume.pdf`} className="mt-4 sm:mt-0">
              <MagicButton
